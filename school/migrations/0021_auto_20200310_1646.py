...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='phone_number',
            field=models.CharField(max_length=13, validators=[django.core.validators.RegexValidator(message='invalid phone number, phone number should be in the format of +254', regex='(\\+254)\\s*?(\\d{3})\\s*?(\\d{3})\\s*?(\\d{3})')]),
        ),
        migrations.AlterField(
